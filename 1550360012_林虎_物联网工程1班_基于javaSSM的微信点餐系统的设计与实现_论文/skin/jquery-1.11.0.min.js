...
!function (a, b) {
  ...
  var c = [],
    ...
    var c, d;if (!a) return this;if ("string" == typeof a) {
      ...
      D = { children: !0, contents: !0, next: !0, prev: !0 };n.extend({ dir: function (a, b, c) {
      var d = [],
    ...
    n.valHooks[this] = { set: function (a, b) {
      ...
      sc = l.input;n.fn.extend({ attr: function (a, b) {
    ...
    n.attrHooks[b] = { set: function (a, c) {
      ...
      uc = /^(?:a|area)$/i;n.fn.extend({ prop: function (a, b) {
    ...
    if (a.crossDomain) {
      var b,
          c = z.head || n("head")[0] || z.documentElement;return { send: function (d, e) {
      ...
      bd = /(=)\?(?=&|$)|\?\?/;n.ajaxSetup({ jsonp: "callback", jsonpCallback: function () {
